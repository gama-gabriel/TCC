...
public class conceitos_menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_conceitos_menu);
        ...
        botao_continuar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (check_1.isChecked())
                {
                    Intent intent = new Intent(conceitos_menu.this, conceito_1ponto1.class);
                    startActivity(intent);
                }
                if (check_2.isChecked())
                {
                    Intent intent = new Intent(conceitos_menu.this, conceitos_menu_2.class);
                    startActivity(intent);
                }

                if (check_3.isChecked())
                {
                    Intent intent = new Intent(conceitos_menu.this, conceito3.class);
                    startActivity(intent);
                }
    ...
    private void IniciarComponentes(){
        ...
        botao_continuar = findViewById(R.id.botao_continuar);
